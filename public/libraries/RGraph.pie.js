    ...
    RGraph.Pie = function (conf)
    {
        ...
        this.getShape = function (e)
        {
            ...
            for (var i=0,len=angles.length; i<len; ++i) {
                ...
                if (this.type === 'pie' && prop.variant.indexOf('donut') !== -1) {
                    this.path(
                        'a % % % % % true',
                        angles[i][2],angles[i][3],(typeof prop.variantDonutWidth == 'number' ? this.radius - prop.variantDonutWidth : this.radius / 2),angles[i][1],angles[i][0]
                    );
                } else {
                    this.path(
                        'l % %',
               ...
               angleStart: angles[i][0],
                 angleEnd: angles[i][1],
                  ...
                  dataset: 0,
          sequentialIndex: i,
                    label: prop.labels && typeof prop.labels[i] === 'string' ? prop.labels[i] : null,
        ...
        this.highlight = function (shape)
        {
            if (prop.tooltipsHighlight) {
                ...
                //
                    ...
                    //        this.context.arc(shape.x, shape.y, typeof prop.variantDonutWidth == 'number' ? this.radius - prop.variantDonutWidth : shape.radius / 2, shape.angleEnd, shape.angleStart, true);
                    //    } else {
